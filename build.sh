...
until [ "$selection" = "0" ]; do
  ...
  echo "    	 3  -  Red Hat Enterprise Linux 8"
  echo "    	 4  -  AlmaLinux OS 8"
  echo "    	 5  -  Rocky Linux 8"
  echo "    	 6  -  CentOS Stream 8"
  echo ""
  echo "      Microsoft Windows:"
  echo ""
  echo "    	 7  -  Windows Server 2022 - All"
  echo "    	 8  -  Windows Server 2022 - Standard Only"
  echo "    	 9  -  Windows Server 2022 - Datacenter Only"
